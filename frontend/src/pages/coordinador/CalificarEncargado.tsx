...
const CRITERIOS: Criterio[] = [
  { key: 'puntualidad',  label: 'Puntualidad',  pregunta: '¿El encargado preparó el material a tiempo?',              emoji: '⏰' },
  { key: 'orden',        label: 'Orden',         pregunta: '¿El material llegó bien organizado y sin confusiones?',    emoji: '📦' },
  { key: 'comunicacion', label: 'Comunicación',  pregunta: '¿Se comunicó claramente sobre el estado del material?',   emoji: '💬' },
  { key: 'disposicion',  label: 'Disposición',   pregunta: '¿Estuvo dispuesto a apoyar y resolver imprevistos?',      emoji: '🤝' },
]
...
export default function CalificarEncargado() {
  ...
  useEffect(() => {
    api.get(`/listas/${listaId}/calificaciones/`)
      .then(r => {
        if (r.data.ya_califico_coordinador) {
          setYaCalificado(r.data.promedio_al_encargado)
        }
      })
      .catch(() => {})
  }, [listaId])
  ...
  const handleSubmit = async () => {
    ...
    setError('')
    try {
      await api.post(`/coordinador/listas/${listaId}/calificar-encargado/`, {
        ...calificaciones,
        comentario,
      })
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-green-900 text-white px-4 py-5 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold">Calificar Encargado</h1>
        </div>
        <div className="flex flex-col items-center justify-center p-8 gap-4 mt-12">
          ...
          <p className="text-gray-500 text-sm text-center">Ya calificaste al encargado de este evento.</p>
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      <div className="bg-green-900 text-white px-4 py-5 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-lg font-bold">Calificar Encargado</h1>
          <p className="text-green-300 text-xs">¿Cómo estuvo el manejo del material?</p>
        </div>
      </div>
      ...
      <div className="p-4 max-w-lg mx-auto flex flex-col gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
          ...
          <textarea
            ...
            placeholder="¿Algo más que quieras compartir sobre el encargado?"
