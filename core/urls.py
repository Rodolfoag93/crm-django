...
urlpatterns = [
    ...
    path('cotizaciones/nueva/rally/', views.nueva_cotizacion_rally, name='nueva_cotizacion_rally'),
    ...
    path('rutas/<int:ruta_id>/editar/', views.editar_ruta, name='editar_ruta'),
    ...
    path('rutas/parada/<int:parada_id>/eliminar/', views.eliminar_parada, name='eliminar_parada'),
